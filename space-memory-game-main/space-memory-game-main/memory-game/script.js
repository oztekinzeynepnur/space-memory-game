...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function botMove() {
    ...
    const unflipped = unmatched.filter(
  ...
  function showWinModal() {
    ...
    if (gameMode === "single") {
      ...
      const winner =
        gameState.player1.matches > gameState.player2.matches
          ? 1
          : gameState.player2.matches > gameState.player1.matches
          ? 2
      ...
      winnerStats = `
                ...
                <div class="achievement">
                    ...
                    <p>Eşleşmeler: ${
                      winner === 1
                        ? gameState.player1.matches
                        : gameState.player2.matches
                    }</p>
                </div>
                <div class="achievement">
                    <i class="material-icons">stars</i>
  ...
  // Oyunu başlat
  const modeModal = M.Modal.getInstance(
    document.getElementById("gameModeModal")
  );
  modeModal.open();
});
